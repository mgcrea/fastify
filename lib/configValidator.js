                ...
                if (valid1) {
                  ...
                  if (data1 === undefined) {
                    ...
                    if (valid2) {
                      ...
                      var errs__2 = errors
                      var valid2
                      valid2 = customRule0.call(
                        self,
                        validate.schema.properties.https.then.setDefaultValue,
                        data1,
                        validate.schema.properties.https.then,
                        (dataPath || '') + '.https',
                        data,
                        'https',
                        rootData
...
function customRule0(
  schemaParamValue,
  validatedParamValue,
  validationSchemaObject,
  currentDataPath,
  validatedParamObject,
  validatedParam
) {
