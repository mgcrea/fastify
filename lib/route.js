...
const { ValidatorSelector, SerializerCompiler: buildDefaultSerializer } = require('./schema-compilers')
...
function buildRouting(options) {
  ...
  return {
    setup(options, fastifyArgs) {
      ...
      return503OnClosing = Object.prototype.hasOwnProperty.call(options, 'return503OnClosing')
      ...
      avvio.once('preReady', () => {
        ...
        if (opts.schema) {
          ...
          if (
            ...
            (!this[kValidatorCompiler] || (this[kValidatorCompiler] && schemaBucket.hasNewSchemas()))
          ) {
