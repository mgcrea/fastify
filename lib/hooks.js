...
const applicationHooks = ['onRoute', 'onRegister', 'onReady', 'onClose']
...
const { FST_ERR_HOOK_INVALID_TYPE, FST_ERR_HOOK_INVALID_HANDLER, FST_ERR_SEND_UNDEFINED_ERR } = require('./errors')

const { kReplyIsError, kChildren, kHooks } = require('./symbols')
